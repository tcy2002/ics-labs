...
long long gen_f_pc()
{
    return ((((((ex_mem_curr->icode) == (I_JMP)) & ((mem_wb_curr->icode)
               == (I_ALU))) & ((if_id_curr->icode) != (I_RMMOVQ))) & 
        (ex_mem_curr->takebranch)) ? (ex_mem_curr->vala) : (((
            (ex_mem_curr->icode) == (I_JMP)) & ((mem_wb_curr->icode) != 
            (I_ALU))) & !(ex_mem_curr->takebranch)) ? (ex_mem_curr->vala)
...
long long gen_f_predPC()
{
    return (((if_id_next->icode) == (I_CALL)) ? (if_id_next->valc) : ((
          (if_id_next->icode) == (I_JMP)) & ((if_id_curr->icode) != (I_ALU)
...
{
    return ((((if_id_curr->icode) == (I_JMP)) & ((id_ex_curr->icode) == 
          (I_ALU))) ? (if_id_curr->valc) : ((if_id_curr->icode) == (I_CALL)
...
{
    return ((((id_ex_curr->icode) == (I_JMP)) & (((((ex_mem_curr->icode)
                 == (I_ALU)) & ((if_id_next->icode) != (I_RMMOVQ))) & 
            (ex_mem_next->takebranch)) | (((ex_mem_curr->icode) != (I_ALU))
...
{
    return ((((id_ex_curr->icode) == (I_JMP)) & ((((ex_mem_curr->icode) == 
              (I_ALU)) & (ex_mem_next->takebranch)) | ((
              (ex_mem_curr->icode) != (I_ALU)) & !(ex_mem_next->takebranch)
            ))) | (((id_ex_curr->icode) == (I_MRMOVQ) || 
